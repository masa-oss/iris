...
/**
 * This class is the same as clojure.lang.Numbers .
 * 
 */
...
//			}
    ...
    final static class BigDecimalOps extends OpsP {
        ...
        final static MathContext   MATH_CONTEXT = MathContext.DECIMAL128;
...
//        final static Var MATH_CONTEXT = RT.MATH_CONTEXT;
   ...
   /**
    * This class is the same as <i>clojure.lang.Numbers.Category</i> .
    * 
    */
    ...
    static public float[] float_array(int size, Object init) {
        ...
        if (init instanceof Number) {
            ...
            ISeq s = RT.seq(init);
            for (int i = 0; i < size && s != RT.EOL; i++, s = s.next()) {
